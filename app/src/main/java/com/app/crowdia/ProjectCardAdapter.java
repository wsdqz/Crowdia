...
public class ProjectCardAdapter extends ArrayAdapter<Project> {
    ...
    public ProjectCardAdapter(@NonNull Context context, ArrayList<Project> projects, OnProjectClickListener listener) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.project_card, parent, false);
        }
        ...
        // бейдж если проект собрал полную сумму
